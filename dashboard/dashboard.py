...
# Direktori dataset
data_dir = "C:\\Users\\crism\\Downloads\\tugas\\E-Commerce Public Dataset\\"

#nama crism diganti dengan nama user pc / laptop masing masing 
...
ax.invert_yaxis()
st.pyplot(fig)
fig.savefig(f"{data_dir}produk_terlaris.png")
...
ax.invert_yaxis()
st.pyplot(fig)
fig.savefig(f"{data_dir}waktu_pengiriman.png")
...
st.pyplot(fig)
fig.savefig(f"{data_dir}metode_pembayaran.png")
...
st.pyplot(fig)
fig.savefig(f"{data_dir}rating_review.png")
...
st.pyplot(fig)
fig.savefig(f"{data_dir}tren_pesanan.png")
...
plt.axis("off")
st.pyplot(fig)
fig.savefig(f"{data_dir}lokasi_pelanggan.png")
...
ax.invert_yaxis()
st.pyplot(fig)
fig.savefig(f"{data_dir}pendapatan_produk.png")
...
if "geolocation_lat" in geolocation.columns and "geolocation_lng" in geolocation.columns:
    ...
    ax.axis("off")
    st.pyplot(fig)
    fig.savefig(data_dir + "customer_location.png")
else:
